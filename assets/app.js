(function(){
  ...
  const SERVICES=[
    ...
    {id:'tratamientos',nombre:'Tratamientos',desc:'Nutrición, hidratación y keratina.',img:'https://images.unsplash.com/photo-1541085388142-e84d5b1ab88d?q=80&w=1400&auto=format&fit=crop'}
  ];
